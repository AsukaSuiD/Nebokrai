...
pub struct GodsBattleFactionNpcName {
    pub faction: i32,
    pub name: Vec<u8>,
    pub monsters: Vec<u8>,
}
...
pub struct GodsBattleBaseMoney {
    pub money_level: u32,
    pub add: u32,
    pub subtract: u32,
}
...
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct GodsBattleReviseMoney {
    pub level_gap_revise: u32,
    pub money_level_gap_revise: u32,
    pub revise_min: u32,
    pub revise_max: u32,
}

#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct GodsBattleSzlLevel {
    pub level: u32,
    pub min_szl: u32,
    pub max_szl: u32,
}
...
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct GodsBattleSzlCalculation {
    pub value: u32,
    pub killer_money_level: u32,
    pub victim_money_level: u32,
    pub revise_applied: bool,
}

#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct GodsBattleFactionRule {
    pub faction: u32,
    pub country_a: u32,
    pub country_b: u32,
}
...
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct GodsBattleDieBackPosition {
    pub region: i32,
...
pub enum GodsBattleLoadSection {
    NpcNames,
    BaseMoney,
    ReviseMoney,
    SzlLevels,
...
impl GodsBattleLoadSection {
    ...
    pub const fn missing_notice(self) -> (&'static [u8], &'static [u8]) {
        match self {
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum GodsBattleFactionXydUpdate {
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct GodsBattleNpcFactionUpdate {
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum GodsBattleDecodeSection {
    NpcNames,
    BaseMoney,
    ReviseMoney,
    SzlLevels,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum GodsBattleNpcStringField {
    Name,
    Monsters,
}
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum GodsBattleDecodeError {
    Truncated {
...
impl CGodsBattleConf {
    ...
    pub fn decord_from_byte_array<ReviseMismatch, MissingDieBack>(
        &mut self,
        source: &[u8],
        cursor: &mut usize,
    ...
    pub fn load_from_resources<ReadResource, ResolveNpcName>(
        &mut self,
    ...
    pub fn push_npc(&mut self, npc: GodsBattleFactionNpcName) {
        self.npc_names.push(npc);
    }

    pub fn insert_base_money(
        &mut self,
        key: u32,
    ...
    pub fn push_revise_money(&mut self, value: GodsBattleReviseMoney) {
        self.revise_money.push(value);
    }

    pub fn push_szl_level(&mut self, value: GodsBattleSzlLevel) {
        self.szl_levels.push(value);
    }

    pub fn push_faction_rule(&mut self, value: GodsBattleFactionRule) {
        self.faction_rules.push(value);
    }

    pub fn faction_for_country(&self, country: u8) -> Option<u32> {
        self.faction_rules
            .iter()
            .find(|rule| {
    ...
    pub fn szl_level(&self, szl: u32) -> Option<u32> {
        self.szl_levels
            .iter()
    ...
    pub fn set_xyd_from_db(&mut self, faction_one: u32, faction_two: u32) {
        self.xyd[1] = faction_one;
        self.xyd[2] = faction_two;
    }

    pub const fn faction_xyd(&self) -> (u32, u32) {
        (self.xyd[1], self.xyd[2])
    }

    pub fn set_faction_xyd(&mut self, faction: i32, xyd: u32) -> GodsBattleFactionXydUpdate {
        match faction {
            1 => {
    ...
    pub fn npc_names(&self) -> &[GodsBattleFactionNpcName] {
        &self.npc_names
    }

    pub fn npc_by_name(&self, name: &[u8]) -> Option<&GodsBattleFactionNpcName> {
        self.npc_names.iter().find(|npc| npc.name == name)
    }

    pub fn npc_name_by_monster(&self, original_name: &[u8]) -> Option<&[u8]> {
        self.npc_names
            .iter()
            .find(|npc| {
    ...
    pub fn push_die_back_position(&mut self, value: GodsBattleDieBackPosition) {
        self.die_back_positions.push(value);
    }

    pub fn die_back_position(
        &self,
        region: i32,
        faction: u32,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum GodsBattleStringField {
    NpcName,
    Monsters,
}
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum GodsBattleSerializeError {
    CountOutOfRange {
