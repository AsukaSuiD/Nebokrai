...
//! только полностью прочитанные записи; уже опубликованные записи не
//! откатываются. Общее хранилище STL/SSO заменено контейнерами во владении Rust.
...
pub struct MonsterProperties {
    pub index: u32,
    pub picture_id: u32,
    pub picture_level: u32,
    pub name_color: u32,
    pub hp_bar_color: u32,
    pub sound_id: u32,
    pub tamable: u32,
    pub maximum_tame_attempt_count: u32,
    pub figure: u32,
    pub level: u32,
    pub experience: u32,
    pub yp: u32,
    ...
    pub yao_attack: u32,
    pub minimum_element: u32,
    pub maximum_element: u32,
    pub hit: u32,
    pub defence: u32,
    pub dodge: u32,
    pub attack_speed: u32,
    pub strike_out_time: u32,
    pub move_speed: u32,
    pub element_resistant: u32,
    pub soul_resistant: u32,
    pub hp_recover_speed: u32,
    pub farthest: u32,
    pub nearest: u32,
    pub fight_range: u32,
    pub guard_range: u32,
...
pub struct MonsterDrop {
    pub goods_index: i32,
    pub odds: i32,
    pub maximum_odds: i32,
    pub minimum_money: i32,
    pub maximum_money: i32,
    pub level: i32,
    pub level_attenuation: f32,
    pub level_attenuation_limit: f32,
    pub name: Vec<u8>,
}

#[derive(Clone, Debug, Default, PartialEq)]
pub struct MonsterDropList {
    pub monster_original_name: Vec<u8>,
    pub drops: Vec<MonsterDrop>,
}

pub type MonsterRegistry = BTreeMap<Vec<u8>, MonsterProperties>;
pub type MonsterDropRegistry = BTreeMap<Vec<u8>, MonsterDropList>;

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum MonsterListDecodeError {
    UnexpectedEnd {
        field: &'static str,
        offset: usize,
        needed: usize,
...
pub fn get_monster_property_by_origin_name<'registry>(
...
pub fn get_monster_property_by_origin_index(
...
pub fn get_monster_property_by_picture_id(
    monsters: &MonsterRegistry,
    picture_id: u32,
) -> Option<&MonsterProperties> {
    monsters
...
pub fn get_monster_property_by_origin_name_mut<'registry>(
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct MonsterListSerializeError {
