...
pub struct CiQingMakeNode {
    pub destination_base_index: u32,
    pub equipment_position: u32,
    pub source_a_base_index: u32,
    pub source_a_count: u32,
    pub source_b_base_index: u32,
    pub source_b_count: u32,
}

#[derive(Clone, Debug, Default, Eq, PartialEq)]
pub struct CiQingComposeNode {
    pub source_a_base_index: u32,
    pub source_b_base_index: u32,
    pub compose_probability: u32,
    pub money: u32,
    pub crystal_count: u32,
    pub declared_result_count: u32,
    pub results: Vec<(u32, u32)>,
}

#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct CiQingImproveNode {
    pub level: u32,
    pub base_index: u32,
    pub probability: u32,
}
...
impl CCiQingSetup {
    ...
    pub fn push_make(&mut self, node: CiQingMakeNode) {
        self.make.push(node);
    }

    pub fn push_compose(&mut self, node: CiQingComposeNode) {
        self.compose.push(node);
    }

    pub fn push_improve(&mut self, node: CiQingImproveNode) {
        self.improve.push(node);
    }

    pub fn make(&self) -> &[CiQingMakeNode] {
        &self.make
    }

    pub fn compose(&self) -> &[CiQingComposeNode] {
        &self.compose
    }

    pub fn compute_node(&self, source_a: u32, source_b: u32) -> Option<CiQingComposeNode> {
        self.compose
            .iter()
            .find(|node| {
    ...
    pub fn random_choice(node: &CiQingComposeNode, mut random: impl FnMut(i32) -> i32) -> u32 {
    ...
    pub fn improve(&self) -> &[CiQingImproveNode] {
        &self.improve
    }

    pub fn improve_node(&self, level: u32) -> Option<CiQingImproveNode> {
        self.improve
            .iter()
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct CiQingSerializationBlock {
    pub section: CiQingCountSection,
    pub count: usize,
}
