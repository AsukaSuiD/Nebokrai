...
impl CWordsFilter {
    ...
    pub fn check(&self, value: &mut Vec<u8>, replace: bool) -> bool {
    ...
    pub fn check_with_numeric_gate(
        &self,
        value: &mut Vec<u8>,
        replace: bool,
        ...
        for filter in &self.filters {
            ...
            loop {
                if filter.len() == 1 && position >= 1 && value[position - 1] & 0x80 != 0 {
    ...
    pub fn add_to_byte_array(
        ...
        let range_count = i32::try_from(self.char_code_filter.ranges().len()).map_err(|_| {
    ...
    pub fn filter_file_name(&self) -> &[u8] {
        &self.filter_file_name
    }

    pub fn char_code_file_name(&self) -> &[u8] {
        &self.char_code_file_name
    }
...
pub enum WordsFilterSerializeSection {
    CharacterRanges,
    BannedWords,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct WordsFilterSerializeError {
    pub section: WordsFilterSerializeSection,
    pub count: usize,
}
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum WordsFilterDecodeSection {
    CharacterRanges,
    BannedWords,
}
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct WordsFilterDecodeError {
    pub section: WordsFilterDecodeSection,
    pub offset: usize,
    pub needed: usize,
    pub available: usize,
}
