...
//! имеют локальные статусы `UNKNOWN` либо `BLOCKED_MISSING_FACT` ниже.
//!
//! Точные варианты корпуса — пары EXE/PDB Auth, Billing, Login, Misc, Game и
//! World; их идентификаторы (SHA-256) зафиксированы в
//! `server/rust/src/manifest/`.
//! Каноническое описание формата и статусов полей:
//! docs/protocol/message-header.md.
//!
...
//!
//! Экземпляр wire-буфера и момент отправки выбирает направление;
//! Shared несёт только байтовый формат и RLE-поток.
