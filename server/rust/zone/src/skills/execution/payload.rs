...
//! End(int) боевого духа очищает DWORD-фазу перед visual и AfterUse;
//! End(bool) очищает BYTE-флаги, но не заменяет End(int). Конкретный
//! владелец выбирает соответствующий пролог.
//!
