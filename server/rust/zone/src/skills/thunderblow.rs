...
//! Пара навыка и его области слита в один файл: конструктор области
...
//!   FIX: порядок машинный — списание MP, обновление состояния и поворот
//!   идут до повторной проверки дальности; её отказ теряет уже списанные
//!   MP и поворот, общий хвост AfterUse выполняется. Достижимо только при
...
//! (`_can_be_breaked`); потребители поля +0x3C этой стороны не установлены.
