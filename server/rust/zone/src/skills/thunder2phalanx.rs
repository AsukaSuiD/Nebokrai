...
//!
//! Машинные quirks: все уровни имеют одну активную ячейку; по истечении
//! срока область обходит свою ячейку, бьёт каждую цель один раз и удаляется
//! (пометка удаления — только после всех попаданий); ReplaceAffectRegion
//! выключает совпавшую клетку, которую общий AddObject не вызывает.
//!
