...
//! Run-делегации (обход клетки, регистрация) остаются у прежнего владельца.
//!
//! Машинный факт: все уровни имеют одну активную ячейку.
//!
//! - ctor `0x1E4810` (VA `0x5E4810`): число и полный маппинг аргументов
//!   доказательной базой не раскрыты — поля следуют прежнему телу
//!   (PARTIAL).
...
//!   Decord не перенесён, как и у прежнего владельца.
