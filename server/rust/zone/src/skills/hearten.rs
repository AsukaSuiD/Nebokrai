...
//! AI `0x151950`; состояние — общий AI-fold `0x1D5BA0`. Прежний переходный
//! владелец — `src/gameserver/appserver/skills/hearten.rs`; тела Check/AI
...
//! реализован у прежнего владельца; разрешение `begin_target`,
