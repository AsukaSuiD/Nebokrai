...
//! Прежний переходный владелец — `src/gameserver/appserver/skills/fatalblow.rs`;
//! тела перенесены буквально порцией №6b «BF-ядро».
//!
...
//! Serialize — точечно, решение C порции №6b) предшествуют CAN/visual0/condition
