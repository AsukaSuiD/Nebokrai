...
//! усечения в i64 с чтением младших 32 бит. Маппинг 6 аргументов ctor
//! досмотрен (VERIFIED, точная пара): level, min, max, elem после базовых
//! (master&, lifetime); elem — сырое Query(20015) Summon-стороны.
//!
