...
//! Сверено по HasTarget, сравнению object/point в CPlayerAI, чтению ID
//! команды с очисткой старшего бита и выбору формы цели; опорные адреса —
//! таблица CPlayerAI в docs/reconstruction/gameserver-npc-and-regions.md.
