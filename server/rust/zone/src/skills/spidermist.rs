...
//!
//! Маппинг 6 аргументов ctor области досмотрен (VERIFIED, точная пара):
//! level, state_lifetime, frequency, hp_loss после базовых
//! (master&, lifetime). Остаются: конфиг-зависимость 5×5 таблиц области в
//! этой сборке константна; имя слота и owned-visual — INFERRED и не
//! достраиваются догадкой; см. раздел по ссылке ниже.
//!
