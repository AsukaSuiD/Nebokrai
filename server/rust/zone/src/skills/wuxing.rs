...
//!
//! Машинно установлено: общий зарегистрированный AI читает все двадцать
//! четыре свойства в приведённом ниже порядке ещё до выбора GetU/GetS, затем
...
//! Тела `CWuXing*::AI` пяти элементов сняты дизассемблом и сверены с этой
//! таблицей без расхождений — VERIFIED (Fire/Water/Wood уточняют сужение
//! MAX_HP и металловую добавку MAX_MP; откат GetU→GetS подтверждён).
//! Опорные адреса AI и x87-точность формулы — шапка zone/effects/wuxing.rs.
//!
