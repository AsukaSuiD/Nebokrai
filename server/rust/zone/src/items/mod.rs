...
pub mod camountlimitgoodsshadowcontainer; // CAmountLimitGoodsShadowContainer: count-limit слой shadow-контейнера.
...
pub mod cequipmentcomposeshadowcontainer; // CEquipmentComposeShadowContainer: 3-слотовая shadow-сессия compose base/sub/result.
pub mod cequipmentcontainer; // CEquipmentContainer: позиционное ядро экипировки (17 колонок) с add/remove/swap и fairy growth.
pub mod cequipmentdakongcontainer; // CEquipmentDaKongContainer: 8-слотовая DaKong shadow-сессия с consumption ledger.
pub mod cequipmentupgradeshadowcontainer; // CEquipmentUpgradeShadowContainer: 5-слотовая shadow-сессия улучшения с gem-валидацией.
...
pub mod cvolumelimitgoodsshadowcontainer; // CVolumeLimitGoodsShadowContainer: позиционный cell-слой shadow-контейнера.
