...
//!
//! Волна Z-C2a сверила depot-нумерацию, собранную из констант кода склада, как
//! и остальные значения выше: wire extend-id `9` уже покрыт вариантом ниже,
//! а константа `161` — внутренний конец расширения позиций (`96 + 13·5`), не
