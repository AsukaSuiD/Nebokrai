...
//! Клиентский ответ — очередной элемент последовательности в слове `+0x0C`
//! исходящих game-сообщений (docs/reconstruction/client-wire-runtime.md);
//! исходный GameServer этой сборки входящие штампы заголовка не читает,
//! поэтому состояние здесь хранится, а ответ не сверяется.
