//! Формулы боевого опыта и property-пакеты `CMonster` Zone — первая порция
//! волны monster. Исходный владелец — `appserver/monster.h/.cpp`; переходный
//! `CMonster` старого пакета делегирует сюда без изменения сигнатур методов,
//! передавая свои hub-поля типизированными параметрами.
//!
