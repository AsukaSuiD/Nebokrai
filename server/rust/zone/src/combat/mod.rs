//! Расчёт атаки Zone: данные результата и источника, базовая защита
//! `CFightDefense`, формулы опыта/свойств монстра и оружейный roll;
//! применение к живой цели остаётся у вызывающих владельцев стадии Attack.
//!
//! Контракт: `docs/gameplay/combat.md`.
...
pub use fightdefense::PlayerCombatProperties;
pub use fightdefense::{ // тела базовой защиты по парам источник–цель.
...
pub use weaponattack::{PlayerWeaponRoll, WeaponDamageLiveField, WeaponPowerBoost, WeaponSourceCombat, WeaponSourceProperty};
pub use weaponattack::{apply_weapon_critical, fill_weapon_damage, weapon_source_property};
