...
// Переэкспорт записей состояний: данные, константы ID/размера и wire-проекции.
pub use agility::{
...
pub use ride::{RIDE_STATE_ID, RideState};
...
pub use teamstate::{CTeamState, TEAM_STATE_ID};
...
pub use undead::{UNDEAD_STATE_ID, UndeadState};
