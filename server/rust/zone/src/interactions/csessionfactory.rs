...
//! container-listener-ов по owner остаются у прежнего владельца `CGame`; старый
//! файл держит обёртку владения для coherent-impl шва around-runtime
//! неперенесённого слоя.
//!
