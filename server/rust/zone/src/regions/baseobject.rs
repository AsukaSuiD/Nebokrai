...
// STATUS: UNKNOWN (сохранены только метаданные исследования)
// IMPLEMENTED_SUBCHAIN: ветви type 500/600 материализованы в старом пакете как
// `create_npc/create_monster` (src/gameserver/appserver/baseobject.rs);
// остальные variants и erased return остаются RAW.
// COMPONENT: GameServer
// ARTIFACT: GameServer/gameserver.exe + GameServer/GameServer.pdb
