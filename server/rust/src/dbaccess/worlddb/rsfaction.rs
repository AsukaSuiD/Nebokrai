//! DB-владелец `CRsFaction` WorldServer из `rsfaction.cpp`; трейт `RsFactionOwner`
//! и его data-семья перенесены в Realm `organizations/rsfaction`, здесь остаётся
...
use nebokrai_realm::app::world_game_view::WorldGameView;
...
use crate::worldserver::appworld::organizingsystem::faction::{
    CFaction, FactionDatabaseBaseState, TagApplyPerson, TagLeaveWord, TagPronounceWord,
};
...
pub(crate) use nebokrai_realm::organizations::rsfaction::*;
