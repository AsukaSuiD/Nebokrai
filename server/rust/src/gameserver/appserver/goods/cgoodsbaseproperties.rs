...
pub(crate) const GAP_ROLE_MINIMUM_WAKAN_LIMIT: i32 = 10;
pub(crate) const GAP_REQUIRE_OCCUPATION: i32 = 11;
pub(crate) const GAP_REQUIRE_GENDER: i32 = 12;
pub(crate) const GAP_PARTICULAR_ATTRIBUTE: i32 = 0x0d;
pub(crate) const GAP_MINIMUM_ATTACK_CORRECTION: i32 = 14;
pub(crate) const GAP_MAXIMUM_ATTACK_CORRECTION: i32 = 15;
pub(crate) const GAP_ELEMENT_ATTACK_CORRECTION: i32 = 16;
pub(crate) const GAP_ARMOR_CORRECTION: i32 = 17;
pub(crate) const GAP_ATTACK_SPEED_CORRECTION: i32 = 18;
pub(crate) const GAP_HIT_RATE_CORRECTION: i32 = 19;
pub(crate) const GAP_FATAL_BLOW_RATE_CORRECTION: i32 = 20;
pub(crate) const GAP_DODGE_CORRECTION: i32 = 21;
pub(crate) const GAP_SKILL_REUSE_TIME_CORRECTION: i32 = 22;
pub(crate) const GAP_ELEMENT_RESISTANCE_CORRECTION: i32 = 23;
pub(crate) const GAP_HP_RESTORE_SPEED_CORRECTION: i32 = 25;
pub(crate) const GAP_MP_RESTORE_SPEED_CORRECTION: i32 = 26;
pub(crate) const GAP_STRENGTH_CORRECTION: i32 = 27;
pub(crate) const GAP_AGILITY_CORRECTION: i32 = 28;
pub(crate) const GAP_CONSTITUTION_CORRECTION: i32 = 29;
pub(crate) const GAP_WAKAN_CORRECTION: i32 = 30;
pub(crate) const GAP_HP_UPPER_LIMIT_CORRECTION: i32 = 31;
...
pub(crate) const GAP_RETURN_TO_TOWN: i32 = 45;
pub(crate) const GAP_RANDOM_TRANSMIT: i32 = 46;
pub(crate) const GAP_EXECUTE_SCRIPT: i32 = 47;
...
pub(crate) const GAP_BURDEN_UPPER_LIMIT_CORRECTION: i32 = 52;
pub(crate) const GAP_MINIMUM_ATTACK_UPGRADE: i32 = 53;
pub(crate) const GAP_MAXIMUM_ATTACK_UPGRADE: i32 = 54;
pub(crate) const GAP_ELEMENT_ATTACK_UPGRADE: i32 = 55;
pub(crate) const GAP_ARMOR_UPGRADE: i32 = 56;
pub(crate) const GAP_ATTACK_SPEED_UPGRADE: i32 = 57;
pub(crate) const GAP_HIT_RATE_UPGRADE: i32 = 58;
pub(crate) const GAP_FATAL_BLOW_RATE_UPGRADE: i32 = 59;
pub(crate) const GAP_DODGE_UPGRADE: i32 = 60;
pub(crate) const GAP_ROLE_MINIMUM_LEVEL_LIMIT_UPGRADE: i32 = 61;
pub(crate) const GAP_ROLE_MINIMUM_STRENGTH_LIMIT_UPGRADE: i32 = 62;
pub(crate) const GAP_ROLE_MINIMUM_AGILITY_LIMIT_UPGRADE: i32 = 63;
pub(crate) const GAP_ROLE_MINIMUM_CONSTITUTION_LIMIT_UPGRADE: i32 = 64;
pub(crate) const GAP_ROLE_MINIMUM_WAKAN_LIMIT_UPGRADE: i32 = 65;
pub(crate) const GAP_GOODS_MAXIMUM_DURABILITY_UPGRADE: i32 = 66;
pub(crate) const GAP_HP_UPPER_LIMIT_CORRECTION_UPGRADE: i32 = 67;
pub(crate) const GAP_MP_UPPER_LIMIT_CORRECTION_UPGRADE: i32 = 68;
pub(crate) const GAP_SKILL_REUSE_TIME_CORRECTION_UPGRADE: i32 = 69;
pub(crate) const GAP_STIFFEN_PROBABILITY_CORRECTION_UPGRADE: i32 = 70;
pub(crate) const GAP_BURDEN_UPPER_LIMIT_CORRECTION_UPGRADE: i32 = 71;
pub(crate) const GAP_ANIMA_BIND: i32 = 104;
pub(crate) const GAP_EQUIP_ACTIVE: i32 = 105;
pub(crate) const GAP_ITEM_QUALITY: i32 = 106;
pub(crate) const GAP_GOODS_UPGRADE_PRICE: i32 = 72;
pub(crate) const GAP_ELEMENT_RESISTANCE_CORRECTION_UPGRADE: i32 = 73;
pub(crate) const GAP_GEM_TYPE: i32 = 79;
pub(crate) const GAP_GEM_LEVEL: i32 = 80;
pub(crate) const GAP_GEM_PROBABILITY: i32 = 81;
pub(crate) const GAP_GEM_UPGRADE_SUCCEED_RESULT: i32 = 82;
pub(crate) const GAP_GEM_UPGRADE_FAILED_RESULT: i32 = 83;
pub(crate) const GAP_MOUNT_TYPE: i32 = 84;
...
pub(crate) const GAP_FULL_MISS: i32 = 93;
pub(crate) const GAP_WEAPON_DAMAGE_UPGRADE: i32 = 94;
pub(crate) const GAP_BLAST_ATTACK: i32 = 95;
pub(crate) const GAP_BLAST_ELEMENT_ATTACK: i32 = 96;
pub(crate) const GAP_FUMO_PROPERTY: i32 = 97;
...
pub(crate) const GAP_BREAK_ARMOUR: i32 = 128;
pub(crate) const GAP_PUNCTURE: i32 = 129;
pub(crate) const GAP_BREAK_ELEMENT: i32 = 130;
pub(crate) const GAP_BREAK_BOUND: i32 = 131;
pub(crate) const GAP_GOLD_POWER: i32 = 132;
pub(crate) const GAP_SKILL_ID: i32 = 135;
pub(crate) const GAP_SKILL_LEVEL: i32 = 136;
pub(crate) const GAP_CHANGEBODY_TYPE: i32 = 138;
pub(crate) const GAP_BAOSHI_COLOR: i32 = 139;
pub(crate) const GAP_DAKONG_1: i32 = 140;
pub(crate) const GAP_DAKONG_EXTERN_1: i32 = 147;
pub(crate) const GAP_DAKONG_EXTERN_2: i32 = 148;
pub(crate) const GAP_DAKONG_EXTERN_3: i32 = 149;
...
pub(crate) const GAP_BF_POTENTIAL: i32 = 163;
...
pub(crate) const GAP_BF_SKY: i32 = 178;
pub(crate) const GAP_BF_EARTH: i32 = 179;
pub(crate) const GAP_BF_MAN: i32 = 180;
...
pub(crate) const GAP_BF_SPRITE_POTENTIAL: i32 = 188;
pub(crate) const GAP_BF_BLAST_POTENTIAL: i32 = 189;
pub(crate) const GAP_BF_BRAVE_POTENTIAL: i32 = 190;
pub(crate) const GAP_BF_AGILITY_POTENTIAL: i32 = 191;
pub(crate) const GAP_BF_SPRITUALISM_POTENTIAL: i32 = 192;
pub(crate) const GAP_BF_STRENGH_POTENTIAL: i32 = 193;
...
pub(crate) const GAP_CIQING_PROPERTY1: i32 = 243;
pub(crate) const GAP_CIQING_PROPERTY2: i32 = 244;
pub(crate) const GAP_BF_LIFE_GROW: i32 = 209;
pub(crate) const GAP_BF_MP_GROW: i32 = 210;
pub(crate) const GAP_BF_ATTACK_GROW: i32 = 211;
pub(crate) const GAP_BF_SPRITE_GROW: i32 = 212;
pub(crate) const GAP_BF_ABRAVE_GROW: i32 = 213;
pub(crate) const GAP_BF_AGILITY_GROW: i32 = 214;
pub(crate) const GAP_BF_SPRITUALISE_GROW: i32 = 215;
pub(crate) const GAP_BF_STRENGH_GROW: i32 = 216;
pub(crate) const GAP_BF_MAX_LEVEL: i32 = 217;
pub(crate) const GAP_BF_CUT_HURT_SCALE: i32 = 218;
pub(crate) const GAP_BF_WEAPON_LEVEL: i32 = 219;
...
pub(crate) const GAP_BF_HUOXIESHU_SKILL: i32 = 224;
pub(crate) const GAP_BF_LINGZHISHU_SKILL: i32 = 225;
pub(crate) const GAP_BF_BFEQUIPEMENT: i32 = 226;
pub(crate) const GAP_BF_CUT_HURT_ADDON: i32 = 227;
