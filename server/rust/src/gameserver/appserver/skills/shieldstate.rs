...
//! Диспетчер вариантов, правило пропуска ID и стихийная формула Promotion
//! перенесены в Zone `effects/defenseshield.rs` и `effects/promotion.rs`;
//! здесь остаются живые Begin/restart/AI/End.
...
use super::lifeshieldstate::add_life_shield_cure;
...
pub(crate) use nebokrai_zone::effects::DefenseShieldState;
