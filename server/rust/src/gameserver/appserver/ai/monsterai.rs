...
//! Остальные AI-ветви ещё требуют реконструкции; полный декомпилят хранится локально.
        ...
        loop {
            let registered = owner.as_ref().and_then(|region| {
                ...
                (matches!(skill.owner(), SkillOwner::CStrike | SkillOwner::CYakshaSlash | SkillOwner::CSeal
                    ...
                    | SkillOwner::CFireWall | SkillOwner::CChaosSphere | SkillOwner::CSoulMirror
                    | SkillOwner::CLightning | SkillOwner::CChainLightning | SkillOwner::CInfernol)
