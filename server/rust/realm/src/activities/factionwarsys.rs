...
impl FactionWarType {
    pub const fn new(war_type: i32, fight_time_ms: i32, money: i32) -> Self {
        Self {
            war_type,
            fight_time_ms,
            money,
    ...
    pub const fn fight_time_ms(self) -> i32 {
        self.fight_time_ms
    }
}
...
pub enum FactionWarIniLoadCompletion {
    FileMissing,
    FormatStopped,
    Loaded,
}
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct FactionWarIniLoadReport {
    pub completion: FactionWarIniLoadCompletion,
    pub parsed_records: u32,
    pub legacy_result: bool,
}

#[derive(Debug)]
pub struct FactionWarInitializationReport {
    pub enemy_faction_load_succeeded: bool,
    pub loaded_relation_records: usize,
    pub applied_relation_records: usize,
    pub ini: FactionWarIniLoadReport,
    pub legacy_result: bool,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum FactionWarInitializationBlock {
    EnemyRelation(FactionEnemyMutationBlock),
}

#[derive(Clone, Debug, Eq, PartialEq)]
pub enum FactionWarStopBlock<ContextBlock> {
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum FactionWarStopOutcome {
    NotEnemy,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum FactionWarFormatArgument<'a> {
    Text(&'a [u8]),
    Signed(i32),
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct FactionWarFactionSnapshot {
    pub faction_id: i32,
    pub superior_organizing_id: i32,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum FactionWarDeclarationOutcome {
    WarTypeNotFound,
    MasterRequired,
    FactionNotFound,
    SameUnion,
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub enum FactionWarDeclarationBlock<ContextBlock> {
    Context(ContextBlock),
}

pub trait FactionWarDeclarationContext {
    type Block;
    ...
    fn add_enemy_organizing(&mut self, faction_id: i32, enemy_id: i32) -> Result<(), Self::Block>;
    ...
    fn send_player_info(&mut self, player_id: i32, first_text: &[u8], second_text: &[u8]);
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct FactionWarRunReport {
    pub now_ms: u32,
    pub elapsed_ms: u32,
    pub gate_opened: bool,
    pub decremented_relations: usize,
    pub expired_relations: usize,
    pub completed_stops: usize,
    pub registry_only_stops: usize,
    pub skipped_non_enemy_stops: usize,
}

pub trait FactionWarStopContext {
    type Block;
    ...
    fn del_enemy_organizing(&mut self, faction_id: i32, enemy_id: i32) -> Result<(), Self::Block>;
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum FactionWarPlayerDiedOutcome {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub enum FactionWarPlayerDiedBlock<ContextBlock> {
    Context(ContextBlock),
}

pub trait FactionWarPlayerDiedContext {
    type Block;
...
impl CFactionWarSys {
    pub const fn new(start_time_ms: u32) -> Self {
        Self {
    ...
    pub fn clear_enemy_factions_for_load(&mut self) {
    ...
    pub fn initialize_from_loaded_relations<ApplyRelation>(
        &mut self,
    ...
    pub fn load_ini_from_resource(&mut self, source: Option<&[u8]>) -> FactionWarIniLoadReport {
    ...
    pub fn insert_faction_war_type(&mut self, war_type: FactionWarType) {
        self.faction_wars.insert(war_type.war_type, war_type);
    }

    pub fn get_dec_war_money_by_type(&self, war_type: i32) -> i32 {
        self.faction_wars.get(&war_type).map_or(0, |war| war.money)
    }

    pub fn is_enemy_relation(&self, faction_id_1: i32, faction_id_2: i32) -> bool {
    ...
    pub fn clear_enemy_faction(&mut self, faction_id_1: i32, faction_id_2: i32) {
    ...
    pub fn dig_up_the_hatchet<Context>(
        &mut self,
        player_id: i32,
        target_faction_id: i32,
        war_type: i32,
        declaration_time: nebokrai_shared::values::TagTime,
        context: &mut Context,
        ...
        Context: FactionWarDeclarationContext,
    {
        ...
        if player_money < war.money as u32 {
            let first = context
                .format_world_string(b"WS0231", &[FactionWarFormatArgument::Signed(war.money)]);
            let second = context.world_string(b"WS0121");
            context.send_player_info(player_id, &first, &second);
    ...
    pub fn stop_faction_war<Context: FactionWarStopContext>(
        &mut self,
        faction_id_1: i32,
        faction_id_2: i32,
        context: &mut Context,
        ...
        Context: FactionWarPlayerDiedContext,
    {
        ...
        let victor_names = collect_player_died_side_names(context, &victor_side)
            .map_err(FactionWarPlayerDiedBlock::Context)?;
        let notice = context.format_world_string(b"WS0233", &[&victor_names, &defeated_names]);
        context.send_orga_info_to_all(&notice, 0xFFFF_FE92, 0xFFFF_0000);
        context.put_war_log(&notice);
    ...
    pub fn generate_save_data(&self, sink: &impl EnemyFactionSink) {
        let snapshot = self
            .enemy_factions
            .iter()
            .map(|enemy| {
            ...
            .collect();
        sink.set_enemy_factions(snapshot);
    }
}
