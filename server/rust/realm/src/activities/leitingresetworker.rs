...
use super::leitingreset::{LeiTingDatabaseResetOutcome, LeiTingDatabaseResetRequest, TiberiusLeiTingReset};
...
#[derive(Debug)]
pub enum WorldLeiTingResetWorkerEvent {
...
pub struct WorldLeiTingResetWorker {
...
impl WorldLeiTingResetWorker {
 ...
 /// синхронным false-эквивалентом, DB итог приходит независимо позднее.
    pub fn dispatch(
        ...
        let handle = thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let owner = TiberiusLeiTingReset::new(&settings);
    ...
    pub fn try_next_event(&self) -> Option<WorldLeiTingResetWorkerEvent> {
