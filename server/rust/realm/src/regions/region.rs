...
use crate::regions::shapetypes::BaseObjectDecodeError;
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub enum RegionSerializationBlock {
...
pub struct RegionRandomPosition {
    pub x: i32,
    pub y: i32,
    pub found_walkable: bool,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum RegionRandomPositionBlock {
...
impl CRegion {
    ...
    pub fn set_country(&self, country: u8) {
        self.country.set(Some(country));
    }

    pub fn add_base_object_to_byte_array(
        &self,
 ...
 /// прибавить к началу диапазона. Bound `0` допустим и даёт `0`.
    pub fn get_random_pos_in_range<R>(
        &self,
        mut left: i32,
        mut top: i32,
        mut span_x: i32,
