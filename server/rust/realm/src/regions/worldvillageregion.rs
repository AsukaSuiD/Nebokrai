...
use crate::regions::worldregion::{WorldRegionLoadError, WorldRegionLoadedCounts};
use crate::regions::worldwarregion::{CWorldWarRegion, WorldWarRegionSerializationBlock};

pub struct CWorldVillageRegion {
    war: CWorldWarRegion,
}
