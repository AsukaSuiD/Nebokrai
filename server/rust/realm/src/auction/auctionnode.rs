//! Межсерверный узел аукционного товара `CGoodsNode`; формат разделяют Misc-,
//! Game- и WorldServer-варианты.
//!
...
pub enum GoodsNodeUnserializeError {
    UnexpectedEnd {
        field: &'static str,
        offset: usize,
        needed: usize,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum GoodsNodeSerializeError {
    MissingGoodsType,
    MissingLevelLimit,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct GoodsState(i32);

impl GoodsState {
    pub const NONE: Self = Self(0);
    pub const AUCTION: Self = Self(1);
    pub const SUCESSED: Self = Self(2);
    pub const BACK: Self = Self(3);
    pub const UNDO: Self = Self(4);
    pub const PRE_BUY: Self = Self(5);
...
pub struct AuctionDatabaseNodeFields {
    pub add_ticket: u32,
    pub account: Vec<u8>,
    pub owner_id: u32,
    ...
    pub npc_price: i32,
    pub amount: i32,
    pub goods_state: GoodsState,
    pub offer_price: bool,
    pub guid: CGuid,
    pub base_index: u32,
    pub level_limit: u32,
    pub goods_name: Vec<u8>,
    pub seller_name: Vec<u8>,
    pub money_seller: u32,
    pub time_seller: u32,
    pub seller_id: u32,
...
pub struct AuctionListingNodeFields<'value> {
    pub account: &'value [u8],
    pub owner_id: u32,
    pub auction_time: u32,
    pub goods_type: u8,
    pub npc_price: i32,
    ...
    pub guid: CGuid,
    pub level_limit: u32,
    pub goods_name: &'value [u8],
    pub base_index: u32,
    pub seller_money: u32,
    pub seller_time: u32,
    pub seller_ip: &'value [u8],
    pub end_time: u32,
    pub goods_bytes: Vec<u8>,
}

/// Поля одного успешного шага `CPlayer::AutoAddAuctionGoods`.
pub struct AuctionAutomaticNodeFields<'value> {
    pub account: &'value [u8],
    pub owner_id: u32,
    pub money_type: u8,
    pub goods_type: u8,
...
pub struct AuctionDatabaseWriteFields<'node> {
    pub guid: CGuid,
    pub buyer_id: u32,
    pub buyer_name: &'node [u8],
    pub money_type: u8,
    pub seller_money: u32,
    pub seller_id: u32,
    pub goods_state: GoodsState,
...
pub struct AuctionDatabaseInsertFields<'node> {
    pub add_ticket: u32,
    pub account: &'node [u8],
    pub owner_id: u32,
    pub auction_time: u32,
    pub money_type: u8,
    pub goods_type: Option<u8>,
    pub npc_price: i32,
    pub amount: i32,
    pub goods_state: GoodsState,
    pub offer_price: bool,
    pub goods_name: &'node [u8],
    pub level_limit: Option<u32>,
    pub base_index: u32,
    pub seller_name: &'node [u8],
    pub money_seller: u32,
    pub time_seller: u32,
    pub seller_id: u32,
    pub buyer_name: &'node [u8],
...
impl CGoodsNode {
    ...
    pub fn from_auction_database(fields: AuctionDatabaseNodeFields, goods_bytes: Vec<u8>) -> Self {
    ...
    pub fn from_auction_money_return(
        amount: i32,
        guid: CGuid,
        base_index: u32,
        goods_bytes: Vec<u8>,
    ...
    pub fn from_player_listing(fields: AuctionListingNodeFields<'_>) -> Self {
        let mut node = Self::new();
    ...
    pub fn from_automatic_goods(fields: AuctionAutomaticNodeFields<'_>) -> Self {
        let mut node = Self::new();
        node.add_ticket = fields.end_time;
        copy_legacy_database_string(&mut node.account, fields.account);
        node.owner_id = fields.owner_id;
    ...
    pub fn serialize(&self) -> Result<Vec<u8>, GoodsNodeSerializeError> {
        let goods_type = self
            .goods_type
    ...
    pub const fn money_type(&self) -> u8 {
        self.money_type
    }

    pub const fn auction_time(&self) -> u32 {
        self.auction_time
    }

    pub const fn npc_price(&self) -> i32 {
        self.npc_price
    }

    pub fn seller_money(&self) -> u32 {
        self.auction_info.money_seller()
    }

    pub fn seller_id(&self) -> u32 {
        self.auction_info.seller_id()
    }

    pub fn seller_name(&self) -> &[u8] {
        self.auction_info.seller_name()
    }

    pub fn seller_ip(&self) -> &[u8] {
    ...
    pub fn database_write_fields(&self) -> AuctionDatabaseWriteFields<'_> {
    ...
    pub fn database_insert_fields(&self) -> AuctionDatabaseInsertFields<'_> {
    ...
    pub const fn goods_state(&self) -> GoodsState {
        self.goods_state
    }
