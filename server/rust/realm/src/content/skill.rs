...
impl CSkill {
    ...
    pub fn set_skill_type(&mut self, skill_type: i32) {
    ...
    pub fn set_skill_name(&mut self, name: &[u8]) -> Result<(), SkillTextError> {
        set_bounded_c_string(&mut self.name, name, SkillTextField::Name)
    }

    pub fn set_description(&mut self, description: &[u8]) -> Result<(), SkillTextError> {
    ...
    pub fn set_target_type(&mut self, is_target_self: i32) {
        self.is_target_self = is_target_self;
    }

    pub fn add_usage(&mut self, usage: SkillUsage) {
        self.usages.push(usage);
    }

    pub fn serialize(&self) -> Result<Option<Vec<u8>>, SkillSerializeError> {
