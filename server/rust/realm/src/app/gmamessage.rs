//! GMA-dispatcher `OnGMAMessage` WorldServer, перенесённый в Realm `app/`.
//!
...
pub enum WorldGmaKickPlayerTargetKind {
    RoleName,
    Account,
}

#[derive(Debug, Eq, PartialEq)]
pub enum WorldGmaKickPlayerDisposition {
    InvalidPlayer {
        response_type: i32,
        error_text: Vec<u8>,
        wire: Vec<u8>,
...
#[derive(Debug, Eq, PartialEq)]
pub enum WorldGmaMessageOutcome {
    NoOp {
        request_type: i32,
    },
    KickPlayer {
...
pub enum WorldGmaMessageDispatch {
