...
impl IpPortSetup {
    pub fn world_ip(&self) -> Option<&[u8]> {
        self.world_ip.as_deref()
    }

    pub const fn world_port(&self) -> Option<u16> {
        self.world_port
    }

    pub fn local_ip(&self) -> Option<&[u8]> {
...
impl CSetup {
    ...
    pub const fn ip_port(&self) -> &IpPortSetup {
        &self.ip_port
    }
