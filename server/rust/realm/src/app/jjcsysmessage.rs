...
use crate::activities::jjcsystem::{
    CJJcSystem, JjcApplyReport, JjcEndPkReport, JjcGameView, JjcInfo, JjcLogEvent, JjcQuitReport,
    JjcRunConfig, JjcRunContext, JjcUpdateBroadcastReport,
};

#[derive(Debug, Eq, PartialEq)]
pub struct JjcApplyMessageReport {
    pub player_id: i32,
    pub apply: JjcApplyReport,
    pub rejection_delivery: Option<Result<i32, SendMessageError>>,
}

#[derive(Debug, Eq, PartialEq)]
pub enum JjcSystemMessageOutcome {
...
pub fn on_jjc_system_message<
    Game: crate::app::world_game_view::WorldGameView + JjcGameView + ?Sized,
    Context: JjcRunContext + ?Sized,
>(
    game: &mut Game,
