...
use crate::auction::auctionnode::{GoodsNodeSerializeError, GoodsNodeUnserializeError, GoodsState};
use nebokrai_shared::values::CGuid;
use nebokrai_shared::resources::GlobeSetupSnapshot;
use crate::content::goods::GoodsBasePropertiesRegistry;
use crate::persistence::writelog::WorldWriteLogCommand;
use crate::characters::player::{PlayerCodecError, PlayerPropertyCoefficients};
...
pub enum WorldServerAuctionMessageOutcome {
    InputQueued {
        request_type: i32,
...
pub enum WorldServerAuctionMessageDispatch {
    Handled(WorldServerAuctionMessageOutcome),
    Pending(CMessage),
}

struct WorldAuctionNoticeWriteQueue<'a> {
    game: &'a dyn crate::app::world_game_view::WorldGameView,
    queued_sql_count: usize,
}

impl<'a> WorldAuctionNoticeWriteQueue<'a> {
    const fn new(game: &'a dyn crate::app::world_game_view::WorldGameView) -> Self {
        Self {
            game,
            queued_sql_count: 0,
        }
...
pub fn on_msg_s2w_auction(
    game: &mut dyn crate::app::world_game_view::WorldGameView,
