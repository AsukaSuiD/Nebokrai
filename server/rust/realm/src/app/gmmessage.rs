...
pub struct WorldNamedRegionMatch {
    pub region_id: i32,
    pub game_server_index: u32,
    pub game_server_entry_found: bool,
    pub game_server_connected: bool,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct WorldNamedRegionLookup {
    pub skipped_null_owners: usize,
    pub matched: Option<WorldNamedRegionMatch>,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct WorldRegionIdRoute {
    pub map_key: i32,
    pub game_server_id: i32,
}

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct WorldRegionIdRouteScan {
    pub skipped_null_owners: usize,
    pub matching_region_keys: usize,
    pub routes: Vec<WorldRegionIdRoute>,
}
...
use crate::app::worldserver::{WorldReloadBlock, WorldReloadContext};
...
#[derive(Debug, Eq, PartialEq)]
pub enum WorldGmNamedPlayerRouteDisposition {
    TargetRouted {
        response_type: i32,
        wire: Vec<u8>,
        delivery: Result<i32, SendMessageError>,
...
#[derive(Debug, Eq, PartialEq)]
pub enum WorldGmSilienceDisposition {
    TargetRouted {
...
#[derive(Debug, Eq, PartialEq)]
pub enum WorldGmOnlinePlayerCountOutcome {
...
#[derive(Debug, Eq, PartialEq)]
pub enum WorldGmMessageOutcome {
    NoOp {
        request_type: i32,
        request_id: i32,
        request_id_complete: bool,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum WorldGmBanAccountSource {
    MapPlayer,
    Database,
    Missing,
}

pub enum WorldGmMessageDispatch {
    Handled(WorldGmMessageOutcome),
    Pending(CMessage),
}

pub async fn on_gm_message(
    ...
    rs_player: &mut (impl RsPlayerOwner<CPlayer> + ?Sized),
