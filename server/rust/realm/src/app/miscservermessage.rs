...
use super::misc_game::{CGame, legacy_tick_ms};
use crate::app::misc_message::{CMessage, MessageSender, SendMessageError};
use crate::auction::aucitionroom::{
    AddAuctionItemMissingGoodsType, AuctionPageBuildError, UnityGoodsBuild,
};
use crate::auction::auctionnode::{CGoodsNode, GoodsNodeSerializeError, GoodsNodeUnserializeError};
...
pub fn on_msg_w2m_auction(message: &mut CMessage, game: &mut CGame) -> WorldAuctionOutcome {
