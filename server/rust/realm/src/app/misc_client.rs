...
//! чтения.
//!
//! Rust выполняет исходный `OnClose` непосредственно на EOF, не дожидаясь
//! отдельного thread-event: сброс connect-флага, затем публикация `0x16EA01` —
//! тот же наблюдаемый порядок двух эффектов и место публикации.
//!
...
//!
//! Доказательства: docs/reconstruction/realm-services.md#misc-исходящее-world-соединение
