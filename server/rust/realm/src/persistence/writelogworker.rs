...
#[derive(Clone)]
pub struct WorldWriteLogWorkerSpec {
    enabled: bool,
...
#[derive(Debug)]
pub enum WorldWriteLogWorkerEvent {
...
pub enum WorldWriteLogWorkerReport {
    Disabled,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum WorldWriteLogWorkerCompletion {
    Returned(WorldWriteLogWorkerReport),
    Panicked,
}

pub struct WorldWriteLogWorker {
...
impl WorldWriteLogWorker {
    ...
    pub fn try_next_event(&self) -> Option<WorldWriteLogWorkerEvent> {
    ...
    pub fn join(&mut self) -> Option<WorldWriteLogWorkerCompletion> {
...
#[derive(Debug, Error)]
pub enum WorldWriteLogConnectionError {
...
impl WorldWriteLogBatch {
    pub const fn from_snapshot_size(snapshot_size: usize) -> Self {
        Self {
            snapshot_size,
...
pub struct WorldWriteLogDiscardedCommand {
    pub command: WorldWriteLogCommand,
    pub error: tiberius::error::Error,
}
...
#[derive(Debug)]
pub enum WorldWriteLogBatchProgress {
...
pub async fn open_world_write_log_connection(
    settings: &WorldDatabaseSettings,
) -> Result<WorldTdsClient, WorldWriteLogConnectionError> {
...
pub async fn execute_world_write_log_command(
    connection: &mut WorldTdsClient,
