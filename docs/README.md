...
| Что на текущем этапе фиксирует границу совместимости с клиентом? | [Клиент как внешняя граница совместимости](architecture/values-and-compatibility.md#клиент-как-внешняя-граница-совместимости) |
