...
Сначала определите этап: запуск процесса, загрузка конфигурации, соединение с соседней службой, вход игрока или игровое действие. [Диагностика](diagnostics.md) описывает доступные сообщения и ограничения журналирования; [конфигурация и ресурсы](../architecture/resources-and-configuration.md) объясняет, почему изменение файла не всегда сразу меняет активную таблицу.
