...
impl CGame {
    ...
    /// `0x60138`, Goods War command `0x60139` и faction-win `0x6013A`
    /// исполняются; остальные остаются owned pending. Terminal actions
    /// применяются FIFO до следующего сообщения.
