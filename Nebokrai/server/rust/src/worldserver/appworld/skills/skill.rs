...
// Исходный владелец PDB: e:\svn\fengyun_russia_dev\server\worldserver\appworld\skills\skill.cpp
...
// RVA: 0x000DCDC0
// ADDRESS: 004dcdc0
// PROTOTYPE: void __thiscall SetSkillType(long param_1)
//
...
// RVA: 0x000DCDD0
// ADDRESS: 004dcdd0
// PROTOTYPE: void __thiscall SetLevel(long param_1)
//
// Полный декомпилят сохранён в локальном исследовательском корпусе.
//
//
...
// RVA: 0x000DCDE0
// ADDRESS: 004dcde0
// PROTOTYPE: void __thiscall SetSkillName(char * param_1)
//
// Полный декомпилят сохранён в локальном исследовательском корпусе.
//
//
...
// RVA: 0x000DCE00
// ADDRESS: 004dce00
// PROTOTYPE: void __thiscall SetDescription(char * param_1)
//
// Полный декомпилят сохранён в локальном исследовательском корпусе.
//
//
...
// RVA: 0x000DCE20
// ADDRESS: 004dce20
// PROTOTYPE: void __thiscall SetTargetType(int param_1)
//
// Полный декомпилят сохранён в локальном исследовательском корпусе.
//
//
...
// RVA: 0x000DCE50
// ADDRESS: 004dce50
// PROTOTYPE: int __thiscall Serialize(uchar * * param_1, uint * param_2)
//
// Полный декомпилят сохранён в локальном исследовательском корпусе.
//
//
...
// RVA: 0x000DD2F0
// ADDRESS: 004dd2f0
// PROTOTYPE: undefined __thiscall CSkill(long param_1)
//
// Полный декомпилят сохранён в локальном исследовательском корпусе.
//
//
...
// RVA: 0x000DD3A0
// ADDRESS: 004dd3a0
// PROTOTYPE: void __thiscall AddUsage(tagUsage * param_1)
//
// Полный декомпилят сохранён в локальном исследовательском корпусе.
//
//
...
// ============================================================================
// FUNCTION: Unwind@005326c1
// STATUS: UNKNOWN (сохранены только метаданные исследования)
// COMPONENT: WorldServer
// ARTIFACT: WorldServer/Nworldserver.exe + WorldServer/WorldServer.pdb
// SOURCE: e:\svn\fengyun_russia_dev\server\worldserver\appworld\skills\skill.cpp
// RVA: 0x001326C1
// ADDRESS: 005326c1
// PROTOTYPE: undefined Unwind@005326c1()
//
// Полный декомпилят сохранён в локальном исследовательском корпусе.
//
//
