...
//!
//! Статус `QueryGoodsBaseProperties` RVA `0x00055DB0` и
//! `UnserializeGoods` RVA `0x00055E20` — `IMPLEMENTED`; остальной корпус ниже
//! остаётся `UNKNOWN` (исследовательский декомпилят хранится локально). Точная пара:
//! `WorldServer/Nworldserver.exe + WorldServer/WorldServer.pdb`, SHA-256 EXE
//! `F3AC454DAF83E7E9C8F844C725BE2C5A24EFA946C27D75319CFCB68A2F466EF1`, PDB
//! `04E2CC4CE1187A3AAB455566DDC39E72ED7568CAB0EDBD731B4F84629F6EF1E4`.
//! Исходный владелец PDB:
//! `e:\svn\fengyun_russia_dev\server\worldserver\appworld\goods\cgoodsfactory.cpp:38,696`.
//!
//! Старый static `std::map<unsigned long, CGoodsBaseProperties*>` заменён
//! caller-owned `BTreeMap<u32, Option<CGoodsBaseProperties>>`: unsigned
//! key-order и возможность null mapped-value сохранены, а глобальный mutable
//! pointer-lifetime не вводится до восстановления `Load/Release` фабрики.
//! `nullptr` результата выражен `Option`; успешный factory-result остаётся
//! heap-owned `Box<CGoods>`.
//!
