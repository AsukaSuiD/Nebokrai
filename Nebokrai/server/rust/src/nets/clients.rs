...
use crate::transport::{connect_tcp_ipv4, try_write_tcp};
...
pub(crate) const MAX_RECEIVE_CHUNK: usize = 0x2800;
...
pub(crate) struct ClientSendCommand {
    buffer: Vec<u8>,
    offset: usize,
    flags: i32,
}
...
/// сервисов.
pub(crate) struct ClientSendQueue {
...
impl ClientSendQueue {
    ...
    pub(crate) fn send_to_server(&self, buffer: &[u8], prioritized: bool, flags: i32) -> i32 {
    ...
    pub(crate) fn try_flush(&self, stream: &TcpStream) -> Result<FlushOutcome, ClientSendError> {
...
impl TransferCounter {
    ...
    pub(crate) fn add(&mut self, amount: i32, now_ms: u32) -> i32 {
    ...
    pub(crate) const fn total_bytes(&self) -> i64 {
        self.total_bytes
    }
}
