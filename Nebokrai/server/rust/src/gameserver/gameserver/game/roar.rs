...
//!
//! Формулы и lifecycle принадлежат `roarstate.rs`. Здесь остаются только
//! временное извлечение region/player owner-а, атомарный replacement,
//! перерасчёт свойств игрока и around-доставка в порядке end → begin.
