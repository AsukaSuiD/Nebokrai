...
//!
//! Проверки, RNG, формула, выбор целей, окна и снимок принадлежат
//! `snowstorm.rs` и `snowstormphalanx.rs`. Здесь остаются регистрация в регионе
//! и фактическая доставка между независимыми владельцами.

use super::*;

impl CGame {
    pub(crate) fn add_snow_storm_phalanx<Runtime: GameMainLoopRuntime>(&mut self, region_id: i32, phalanx: CSnowStormPhalanx, tile_x: i32, tile_y: i32, started_at_ms: u32, runtime: &mut Runtime) -> Option<Result<i32, RegionMembershipBlock>> {
