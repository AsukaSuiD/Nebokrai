...
// STATUS: PARTIAL_IMPLEMENTATION
// MATERIALIZED: полные packet/equipment ↔ enhancement/equipment-session, двусторонние auction-listing включая hand/depot↔listing, auction-return→packet/equipment/depot, auction-wallet→wallet, packet/equipment/hand/depot/ordinary-fairy↔ground, wallet↔bank gold, direct packet↔equipment и packet/equipment↔depot move/stack/rollback, packet/equipment/depot→hand Put, hand→packet/equipment/depot Put/Swap, packet/equipment/hand/depot↔ordinary-fairy, packet/equipment/hand/depot↔battle-fairy, ordinary-fairy↔battle-fairy, packet/equipment/hand/depot↔CiQing-compose и ordinary-fairy↔CiQing-compose, включая burden/rollback/equipment/fairy-property/hatch/lock/audit/last-operated effects, AuctionLimit, auction packet auto-position/bind-clear, double auction-money capacity gate, exact compose source-slot-2 Put quirk и OT_SWITCH_OBJECT wire; остальные container routes RAW ниже
// COMPONENT: GameServer
// ARTIFACT: GameServer/gameserver.exe + GameServer/GameServer.pdb
