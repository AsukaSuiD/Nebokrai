...
// STATUS: PARTIAL_IMPLEMENTATION
// MATERIALIZED: полные packet/equipment ↔ enhancement/equipment-session, двусторонние auction-listing, auction-return→packet/equipment, ground, wallet↔bank gold, direct packet↔equipment и packet/equipment↔depot move/stack/rollback, packet/equipment/depot→hand Put, hand→packet/equipment/depot Put/Swap, packet/equipment↔ordinary-fairy, packet/equipment↔battle-fairy и packet/equipment↔CiQing-compose, включая burden/rollback/equipment/fairy-property/hatch/lock/audit/last-operated effects, auction packet auto-position/bind-clear, exact compose source-slot-2 Put quirk и OT_SWITCH_OBJECT wire; остальные container routes RAW ниже
// COMPONENT: GameServer
// ARTIFACT: GameServer/gameserver.exe + GameServer/GameServer.pdb
