...
//! `0x8FF01..03`: invite/answer/password join, validation, typed
//! `CTeam/CTeamate`, player membership, `0xBFD01/02/03/07`, recruitment count,
//! World session messages и conditional `0x60209` audit. Остальные selectors
//! и remote reconstruction сохранены ниже как RAW.

use crate::gameserver::appserver::teamstate::CTeamState;
use crate::gameserver::gameserver::game::{
    CGame, GameTeamJoinMutation, GameTeamJoinResult, colored_player_notice_message,
};
