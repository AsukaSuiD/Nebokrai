...
impl CPlayerAI {
    ...
    pub(crate) const fn begin_spider_mist(&mut self, state: PlayerSpiderMistExecutionState) { self.spider_mist = Some(state); }
    ...
    pub(crate) const fn begin_boss_blue_quake(&mut self, state: PlayerBossBlueQuakeExecutionState) { self.boss_blue_quake = Some(state); }
