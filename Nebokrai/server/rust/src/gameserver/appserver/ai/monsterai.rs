...
//! читается после всего обработчика. End(4) базовой/круговой атаки, Thorn и
//! обеих быстрых атак сохраняет выбранный навык до callback и обновляет reuse;
//! все перечисленные, кроме базовой, вызывают SetMoveable(true). Немедленные
//! State/WuXing/Swordship завершают общий ended-флаг и reuse без снятия state.
//! Остальные навыки пока используют
