...
//! читается после всего обработчика. End(4) базовой/круговой атаки и Thorn
//! сохраняет выбранный навык до callback и обновляет reuse; круговая и Thorn
//! также вызывают SetMoveable(true). Остальные навыки пока используют
