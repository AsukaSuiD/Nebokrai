...
/// Выполняет виртуальный `OnLoseTarget` AI10/AI12/AI16: цель очищается,
...
/// Выполняет общую ветвь `Tracing` AI10 и производных AI12/AI16. Слишком
