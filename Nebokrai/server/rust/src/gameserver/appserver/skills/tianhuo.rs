...
pub(crate) fn execute_battle_fairy_tianhuo<Runtime: GameMainLoopRuntime>(
    ...
    if game.battle_fairy_execution(player_id, TIANHUO_SKILL_ID).is_none() {
        ...
        if !skill_is_restored(
            game.battle_fairy_skill_last_used_ms(player_id, TIANHUO_SKILL_ID),
            cooldown_ms,
            cooldown_now_ms,
        ) {
        ...
        .battle_fairy_execution(player_id, TIANHUO_SKILL_ID)
