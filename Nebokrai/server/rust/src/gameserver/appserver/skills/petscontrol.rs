...
fn finish_player_pets_control<Runtime: GameMainLoopRuntime>(game: &mut CGame, player_id: i32, runtime: &mut Runtime) { finish_summon_skill(game, player_id, PETS_CONTROL_SKILL_ID, runtime); }
