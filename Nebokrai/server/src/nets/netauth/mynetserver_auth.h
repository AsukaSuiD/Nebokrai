...
/*
 * Исходный владелец: nets/netauth/mynetserver_auth.cpp
 *
 * AuthServer EXE/PDB: конструктор 0x00012770, CreateServerClient 0x000127B0;
 ...
 *
 * Этот владелец связывает общий CServer с FIFO сообщений Auth и конкретным
