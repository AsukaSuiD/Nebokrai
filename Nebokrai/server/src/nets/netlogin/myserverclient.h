...
/*
 * Owner: nets/netlogin/myserverclient.cpp / .h
 *
 * Точная пара: LoginServer/loginserver.exe + LoginServer/LoginServer.pdb.
 * PDB подтверждает только CMyServerClient::CMyServerClient, destructor/vtable;
 * отдельного состояния и отдельной сетевой семантики owner не добавляет.
 ...
 *
 * В современном C++ owner поэтому остаётся тонким типом над CServerClient:
